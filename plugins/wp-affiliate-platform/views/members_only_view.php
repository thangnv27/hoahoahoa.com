...
function wp_aff_members_only_view() {
    ...
    echo '<div class="wp_aff_welcome_page_graphic wp_aff_portal_page_graphic"><img src="' . WP_AFF_PLATFORM_URL . '/affiliates/images/wp_aff_stats.jpg" alt="Stats Icon" /></div>';
    wp_aff_show_stats();
    echo '</div>';
