...
function wp_aff_show_contact_form()
{
	...
	$output .= '<div class="wp_aff_contact_page_graphic wp_aff_portal_page_graphic"><img src="'.WP_AFF_PLATFORM_URL.'/affiliates/images/contact.png" alt="Contact Icon" /></div>';
