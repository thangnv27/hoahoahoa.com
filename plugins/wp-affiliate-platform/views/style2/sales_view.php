...
function wp_aff_sales_history($aff_sales_table) {
    ...
    if (isset($_POST['info_update'])) {
        ...
        echo '<strong>'.AFF_S_DISPLAYING_SALES_HISTORY . ' ' . $start_date . ' ' . AFF_AND . ' ' . $end_date .'</strong>';
        echo '</div>';
        ...
        if ($wp_aff_sales) {
            ...
            echo '<div class="alert alert-warning">' . AFF_S_NO_SALES_IN_THIS_PERIOD . "</div>";
        }
    } else {
        ...
        if ($resultset) {
            ...
            echo '<div class="alert alert-warning">' . AFF_S_NO_SALES . "</div>";
        }
    }
}
