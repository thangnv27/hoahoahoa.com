...
<div id="footer">
	...
	if($wp_aff_platform_config->getValue('wp_aff_do_not_show_powered_by_section')!='1'){
		...
		if(!empty($aff_id))
		{
			echo '<div style="float:right;">Powered by&nbsp;&nbsp;<a target="_blank" href="https://www.tipsandtricks-hq.com/?p=1474&ap_id='.$aff_id.'">WP Affiliate Platform</a></div>';
		}
		else
		{    
	    	echo '<p style="float:right;">Powered by&nbsp;&nbsp;<a target="_blank" href="https://ppo.vn/affiliate">WP Affiliate Platform</a></p>';
	    }    		
	}  
    ?>
    <div class="clear"></div>
