...
function wp_aff_show_stats() {
    ...
    echo '<div class="row text-center">' . AFF_YOUR_AFF_LINK . $affiliate_link . '</div>';
    echo '<div class="wpap-buffer-10"></div>';
    ...
    if (isset($_POST['info_update'])) {
        ...
        echo '<strong>'.AFF_STATS_OVERVIEW_BETWEEN . ' '. $start_date . ' '. AFF_AND . ' '. $end_date.'</strong>';
        echo '</div>';
        ...
        echo '<div class="alert alert-info">';
        echo '<strong>'.AFF_STATS_OVERVIEW.'</strong>';
        echo '</div>';
